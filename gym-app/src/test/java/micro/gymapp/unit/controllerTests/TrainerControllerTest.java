...
class TrainerControllerTest {
    ...
    void testDeleteTrainingNotFound() {
        ...
        ResponseEntity<?> response = trainerController.deleteTraining(trainingId);
    ...
    void testGetMyProfile_Success() {
        ...
        ResponseEntity<TrainerDTO> response = trainerController.getMyProfile("testTrainer");
    ...
    void testUpdateTrainerProfile_Success() {
        ...
        updateTrainerDTO.setUsername("testTrainer");
        ...
        ResponseEntity<?> response = trainerController.updateTrainerProfile(updateTrainerDTO);
