...
class TraineeControllerTest {
    ...
    void testGetMyProfile_Success() {
        ...
        ResponseEntity<TraineeDTO> response = traineeController.getMyProfile("testUser");
    ...
    void testUpdateTraineeProfile_Success() {
        ...
        updateTraineeDTO.setUsername("John.Doe");
        ...
        when(traineeService.updateTraineeProfile(updateTraineeDTO)).thenReturn(Optional.of(mockTrainee));

        UserDetails mockUserDetails = mock(UserDetails.class);
        when(userService.loadUserByUsername("John.Doe")).thenReturn(mockUserDetails);

        ResponseEntity<?> response = traineeController.updateTraineeProfile(updateTraineeDTO);

        assertEquals(HttpStatus.OK, response.getStatusCode());
        verify(traineeService, times(1)).updateTraineeProfile(updateTraineeDTO);
    }
    ...
    void testGetNotAssignedTrainersList_Success() {
        ...
        ResponseEntity<List<ShortTrainerDTO>> response = traineeController.getNotAssignedTrainersList("testUser");
    ...
    void testUpdateTrainersList_Success() {
        ...
        UpdateTrainersListForm updateTrainersListForm = new UpdateTrainersListForm();
        updateTrainersListForm.setUsername("testUser");
        updateTrainersListForm.setTrainerUsernames(trainerUsernames);
        ...
        ResponseEntity<?> response = traineeController.updateTrainersList(updateTrainersListForm);
    ...
    void testUpdateTraineeProfile_Failure() {
        ...
        when(traineeService.updateTraineeProfile(updateTraineeDTO)).thenReturn(Optional.empty());
    ...
    void deleteUser_validRequest_shouldReturnOkStatus() {
        ...
        ResponseEntity<?> response = traineeController.deleteUser(username);
